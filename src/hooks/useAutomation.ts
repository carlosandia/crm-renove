...
export const useAutomation = (): UseAutomationReturn => {
  ...
  const loadRules = useCallback(async () => {
    try {
      ...
      const response = await fetch('(await import('../config/environment')).environmentConfig.urls.api/api/automation/rules', {
  ...
  const loadMetrics = useCallback(async () => {
    try {
      ...
      const response = await fetch('(await import('../config/environment')).environmentConfig.urls.api/api/automation/metrics', {
        headers: getAuthHeaders()
      });
  ...
  const loadEventDefinitions = useCallback(async () => {
    try {
      ...
      const response = await fetch('(await import('../config/environment')).environmentConfig.urls.api/api/automation/events/definitions', {
        headers: getAuthHeaders()
      });
  ...
  const loadEventLog = useCallback(async (filters?: any) => {
    try {
      ...
      const response = await fetch(`(await import('../config/environment')).environmentConfig.urls.api/api/automation/events/log?${queryParams}`, {
        headers: getAuthHeaders()
      });
  ...
  const updateRule = useCallback(async (ruleId: string, updates: Partial<BusinessRule>): Promise<BusinessRule> => {
    try {
      const response = await fetch(`(await import('../config/environment')).environmentConfig.urls.api/api/automation/rules/${ruleId}`, {
        method: 'PUT',
        headers: getAuthHeaders(),
  ...
  const testRule = useCallback(async (ruleId: string, testData: Record<string, any>): Promise<TestRuleResult> => {
    try {
      const response = await fetch(`(await import('../config/environment')).environmentConfig.urls.api/api/automation/rules/${ruleId}/test`, {
        method: 'POST',
        headers: getAuthHeaders(),
  ...
  const emitEvent = useCallback(async (
    ...
    try {
      const response = await fetch('(await import('../config/environment')).environmentConfig.urls.api/api/automation/events', {
        method: 'POST',
        headers: getAuthHeaders(),
        body: JSON.stringify({
          type,
