...
const PlatformIntegrationsManager: React.FC = () => {
  ...
  const [formData, setFormData] = useState<FormData>({
    client_id: '',
    client_secret: '',
    redirect_uri: `${import.meta.env.VITE_GOOGLE_REDIRECT_URI || (import.meta.env.VITE_ENVIRONMENT === 'production' ? 'https://crm.renovedigital.com.br' : 'http://127.0.0.1:8080')}/auth/google/callback`,
    scopes: [
    ...
    try {
      ...
      if (data) {
        ...
        setFormData({
          ...
          redirect_uri: data.redirect_uri || `${import.meta.env.VITE_GOOGLE_REDIRECT_URI || (import.meta.env.VITE_ENVIRONMENT === 'production' ? 'https://crm.renovedigital.com.br' : 'http://127.0.0.1:8080')}/auth/google/callback`,
          scopes: data.scopes || [
            'https://www.googleapis.com/auth/calendar',
            'https://www.googleapis.com/auth/calendar.events'
          ]
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="${import.meta.env.VITE_GOOGLE_REDIRECT_URI || (import.meta.env.VITE_ENVIRONMENT === 'production' ? 'https://crm.renovedigital.com.br' : 'http://127.0.0.1:8080')}/auth/google/callback"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
              <p className="text-xs text-gray-500 mt-1">
