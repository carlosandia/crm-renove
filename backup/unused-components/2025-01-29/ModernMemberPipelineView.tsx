...
// ❌ REMOVIDO @dnd-kit - import { /* DndContext */, DragEndEvent, DragStartEvent, /* DragOverlay */, useSensor, useSensors, PointerSensor, KeyboardSensor } from '@dnd-kit/core';
          ...
          {pipelineStages.length > 0 ? (
            <div>
              ...
              <div className="bg-yellow-100 border border-yellow-300 rounded-lg p-3 mb-4 text-center">
                <span className="text-sm text-yellow-800 font-medium">⚠️ Drag and Drop temporariamente desabilitado</span>
              </div>
              <div 
