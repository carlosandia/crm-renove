// =====================================================================================
// SCHEMAS ZOD: Preferências de Métricas por Pipeline (Backend)
// Autor: Claude (Arquiteto Sênior)  
// Descrição: Schemas para validação das rotas backend de métricas por pipeline
// =====================================================================================

import { z } from 'zod';

// AIDEV-NOTE: Schema para métricas válidas (deve estar sincronizado com o frontend)
